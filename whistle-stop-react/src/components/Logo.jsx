function Logo({ className = '' }) {
  return (
    <div className={`logo-container flex flex-col items-center text-[#dc2626] text-center leading-[0.9] ${className}`}>
      <style>{`
        .logo-container {
      ...
      <div className="logo-whistle-row" style={{ display: 'flex', alignItems: 'center', fontSize: '1em', letterSpacing: '-0.01em', fontWeight: 700 }}>
        <span>WH</span>
        <div className="logo-barber-pole" style={{ width: '0.35em', height: '1.1em', border: '0.03em solid #dc2626', borderRadius: '0.4em', margin: '0 0.06em', position: 'relative', overflow: 'hidden', background: 'rgba(255,255,255,0.15)', boxShadow: 'inset 0.04em 0 0.08em rgba(0,0,0,0.1)', zIndex: 1, flexShrink: 0 }}>
